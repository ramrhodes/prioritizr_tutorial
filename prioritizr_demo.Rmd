...
The analysis presented in this tutorial comes from a USCB Bren School of Environmental Science & Management master's project by Anna Abelman, Courtney Krone, Vanessa Rathbone, & Rachel Rhodes in collaboration with Wildlife Conservation Society. The project aimed to idenfity priority areas to protect sharks and rays in Mozambique. For more information on the project you can visit: https://bren.ucsb.edu/projects/framework-designing-marine-protected-areas-sharks-and-rays-mozambique
...
prob_1 <- problem(cost = fishing_cost, features = features_stack) %>% 
